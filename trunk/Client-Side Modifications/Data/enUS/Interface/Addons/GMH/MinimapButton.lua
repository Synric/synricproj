function GMHMinimap_Show()
	...
	GameTooltip:AddLine( "|cFF00FF00GMH "..gmhversion.." r"..gmhbuild.."|r" );
	GameTooltip:AddLine( "|cFF00FFCCLeft click to show/hide|r" );
	GameTooltip:AddLine( "|cFFFF0000Right click to drag this|r" );
	if (not opentickets or opentickets < 0) then opentickets=0; end
	GameTooltip:AddLine( "Open Tickets: "..opentickets );
	GameTooltip:Show();
end
